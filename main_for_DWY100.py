...
import numpy as np
from datanew import DBP_100k_new
...
def parse_args(args=None):
    ...
    parser.add_argument('--category', default='YG', type=str)
    parser.add_argument('-save', '--save_path', default='./save/YG_0_3_n1', type=str)
    parser.add_argument('-init', '--init_checkpoint', default=None, type=str)
    parser.add_argument('--p', type=float, default=0.3)
    parser.add_argument('--dim', type=int, default=200) # 256 initial
    # parser.add_argument('--rnd_dim', type=int, default=32)
    parser.add_argument('--num_layers', type=int, default=2)
    parser.add_argument('--inshape', type=int, default=300)
    parser.add_argument('--embedding_shape', type=int, default=200) #initial 300
    parser.add_argument('--sinknum', type=int, default=10)
    parser.add_argument('--color_size', type=int, default=30)
    parser.add_argument('--begin_steps', type=int, default=100) #initial 100
    ...
    parser.add_argument('--data_path', type=str, default='./data/DWY100K')
